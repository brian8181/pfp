...
public:
    ...
    void parse(const string& expression, /*out*/ vector<token>& tokens, stack<terminal_node>& nodes_stack);
...
private:
    ...
    void parse_tokens(/*out*/ vector<terminal_node>& nodes, stack<terminal_node>& nodes_stack);

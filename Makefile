...
# link
$(APPNAME): $(APPNAME).o main.o parser.o node.o token.o
	 $(CXX) $(CXXFLAGS) $(BUILDDIR)/$(APPNAME).o $(BUILDDIR)/main.o $(BUILDDIR)/parser.o $(BUILDDIR)/node.o $(BUILDDIR)/token.o -o $(BUILDDIR)/$(APPNAME)
